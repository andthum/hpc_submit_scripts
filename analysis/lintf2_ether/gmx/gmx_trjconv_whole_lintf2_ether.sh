...
#SBATCH --job-name="trjconv_whole"             # Name for the job allocation
#SBATCH --output="trjconv_whole_slurm-%j.out"  # Filename to which standard output and error will be written
...
echo "=================================================================="
echo "System"\
    | gmx trjconv -f ${settings}_out_${system}.trr\
...
echo "=================================================================="
echo "System"\
    | gmx trjconv -f ${settings}_out_${system}_pbc_whole.xtc\
                  -s ${settings}_${system}.tpr\
                  -o ${settings}_out_${system}_pbc_whole_mol.xtc\
                  -pbc mol\
    || exit
echo "=================================================================="
...
echo "=================================================================="
echo "System"\
    | gmx trjconv -f ${settings}_out_${system}_pbc_whole_mol.xtc\
                  -s ${settings}_${system}.tpr\
                  -o ${settings}_out_${system}_pbc_whole_mol.gro\
                  -dump -1\
    || exit
echo "=================================================================="

echo -e "\n\n\n"
rm -v ${settings}_out_${system}_pbc_whole.xtc
...
mv -v ${settings}_${system}_trjconv_whole_slurm-${SLURM_JOB_ID}.out\
      ${saveDir}\
    || exit
