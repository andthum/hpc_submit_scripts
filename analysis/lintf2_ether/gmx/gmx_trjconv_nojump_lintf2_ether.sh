...
#SBATCH --job-name="trjconv_nojump"             # Name for the job allocation
#SBATCH --output="trjconv_nojump_slurm-%j.out"  # Filename to which standard output and error will be written
...
mv -v ${settings}_${system}_trjconv_nojump_slurm-${SLURM_JOB_ID}.out\
      ${saveDir}\
    || exit
