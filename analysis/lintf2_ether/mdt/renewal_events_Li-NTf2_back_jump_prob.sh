...
#SBATCH --job-name="mdt_renewal_events_Li-NTf2_back_jump_prob"
#SBATCH --output="mdt_renewal_events_Li-NTf2_back_jump_prob_slurm-%j.out"
#SBATCH --nodes=1
...
analysis="renewal_events_Li-NTf2_back_jump_prob"
