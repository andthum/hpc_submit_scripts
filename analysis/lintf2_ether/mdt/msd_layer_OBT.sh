...
gzip --best --verbose "${settings}_${system}_OBT_msd_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OBT_msdx_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OBT_msdy_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OBT_msdz_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OBT_mdx_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OBT_mdy_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OBT_mdz_layer.txt" || exit
...
if [[ ! -d ${save_dir} ]]; then
    ...
    mv -v \
        "${settings}_${system}_OBT_msd_layer.txt.gz" \
        "${settings}_${system}_OBT_msdx_layer.txt.gz" \
        "${settings}_${system}_OBT_msdy_layer.txt.gz" \
        "${settings}_${system}_OBT_msdz_layer.txt.gz" \
        "${settings}_${system}_OBT_mdx_layer.txt.gz" \
        "${settings}_${system}_OBT_mdy_layer.txt.gz" \
        "${settings}_${system}_OBT_mdz_layer.txt.gz" \
