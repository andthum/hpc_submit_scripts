...
#SBATCH --job-name="mdt_renewal_events_Li-ether_back_jump_prob"
#SBATCH --output="mdt_renewal_events_Li-ether_back_jump_prob_slurm-%j.out"
#SBATCH --nodes=1
...
analysis="renewal_events_Li-ether_back_jump_prob"
...
if [[ -f ${settings}_${system}_renewal_events_Li-ether_dtrj.npy ]]; then
    infile="${settings}_${system}_renewal_events_Li-ether_dtrj.npy"
else
    infile="${settings}_${system}_renewal_events_Li-ether_dtrj.npz"
fi
