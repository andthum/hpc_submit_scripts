...
#SBATCH --job-name="mdt_renewal_events_Li-ether_kaplan_meier"
#SBATCH --output="mdt_renewal_events_Li-ether_kaplan_meier_slurm-%j.out"
#SBATCH --nodes=1
...
analysis="renewal_events_Li-ether_kaplan_meier"
