...
save_dir="contact_hist_at_pos_change_Li-OE_slurm-${SLURM_JOB_ID}"
if [[ ! -d ${save_dir} ]]; then
    echo -e "\n"
    mkdir -v "${save_dir}" || exit
    mv -v \
        "${settings}_${system}_contact_hist_at_pos_change_Li-OE_stay.txt" \
        "${settings}_${system}_contact_hist_at_pos_change_Li-OE_leave.txt" \
        "${settings}_${system}_contact_hist_at_pos_change_Li-OE_bins.txt" \
        "${settings}_${system}_contact_hist_at_pos_change_Li-OE_slurm-${SLURM_JOB_ID}.out" \
        "${save_dir}"
