...
save_dir="msd_layer_Li_slurm-${SLURM_JOB_ID}"
if [[ ! -d ${save_dir} ]]; then
    echo -e "\n"
    mkdir -v "${save_dir}" || exit
    mv -v \
        "${settings}_${system}_Li_msd_layer.txt" \
        "${settings}_${system}_Li_msdx_layer.txt" \
        "${settings}_${system}_Li_msdy_layer.txt" \
        "${settings}_${system}_Li_msdz_layer.txt" \
        "${settings}_${system}_Li_mdx_layer.txt" \
        "${settings}_${system}_Li_mdy_layer.txt" \
        "${settings}_${system}_Li_mdz_layer.txt" \
