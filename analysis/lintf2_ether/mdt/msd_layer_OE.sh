...
#SBATCH --job-name="mdt_msd_layer_OE"
#SBATCH --output="mdt_msd_layer_OE_slurm-%j.out"
#SBATCH --nodes=1
...
gzip --best --verbose "${settings}_${system}_OE_msd_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OE_msdx_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OE_msdy_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OE_msdz_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OE_mdx_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OE_mdy_layer.txt" || exit
gzip --best --verbose "${settings}_${system}_OE_mdz_layer.txt" || exit
...
if [[ ! -d ${save_dir} ]]; then
    ...
    mv -v \
        "${settings}_${system}_OE_msd_layer.txt.gz" \
        "${settings}_${system}_OE_msdx_layer.txt.gz" \
        "${settings}_${system}_OE_msdy_layer.txt.gz" \
        "${settings}_${system}_OE_msdz_layer.txt.gz" \
        "${settings}_${system}_OE_mdx_layer.txt.gz" \
        "${settings}_${system}_OE_mdy_layer.txt.gz" \
        "${settings}_${system}_OE_mdz_layer.txt.gz" \
