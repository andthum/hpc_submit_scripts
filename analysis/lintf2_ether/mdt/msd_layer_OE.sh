...
save_dir="msd_layer_OE_slurm-${SLURM_JOB_ID}"
if [[ ! -d ${save_dir} ]]; then
    echo -e "\n"
    mkdir -v "${save_dir}" || exit
    mv -v \
        "${settings}_${system}_OE_msd_layer.txt" \
        "${settings}_${system}_OE_msdx_layer.txt" \
        "${settings}_${system}_OE_msdy_layer.txt" \
        "${settings}_${system}_OE_msdz_layer.txt" \
        "${settings}_${system}_OE_mdx_layer.txt" \
        "${settings}_${system}_OE_mdy_layer.txt" \
        "${settings}_${system}_OE_mdz_layer.txt" \
